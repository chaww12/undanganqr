    ...
    <div class="container mx-auto p-6">
        <div class="flex justify-between mb-4">
            ...
            <div class="flex items-center">
                <a href="{{ route('superadmin.events.show', $event->id) }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-500">
                    Kembali
                </a>
            </div>
        </div>

    ...
    <div class="container mx-auto p-6">
        <div class="flex justify-between mb-4">
            ...
            <div class="flex items-center">
                <a href="{{ route('superadmin.tamu.preview', $event->id) }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-yellow-600 rounded-md hover:bg-yellow-500 mr-2">
                    Buat Undangan
                </a>
                <a href="{{ route('superadmin.tamu.import', $event->id) }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-500 mr-2">
                    Import Data Tamu
                </a>    
                <a href="{{ route('superadmin.kehadiran', $event->id) }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-500 mr-2">
                    Kehadiran
                </a>                     
                <a href="{{ route('superadmin.tamu.index') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-500 mr-2">
                    Kembali
                </a>
            </div>
        </div>
